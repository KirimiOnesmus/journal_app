...
import{Home,Entries,Calendar} from '../components'
  ...
  return (
    <div className='flex'>
        ...
        <main className='flex-1 p-6 bg-gray-100 min-h-screen'>
            ...
            <div className="main-contents flex-1 p-4 mt-14 pb-20 md:pb-4 overflow-y-auto shadow-2xl bg-white rounded-lg shadow-blue-400">
                 <Outlet />
            </div>
