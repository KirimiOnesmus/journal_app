...
import{Home,Entries,CalendarView,ChatAssistant} from '../components'
   ...
   return (
    <div className='flex h-screen overflow-hidden'>
        ...
        <main className='flex-1 p-6 bg-gray-100 min-h-screen overflow-scroll overflow-x-hidden relative'>
            ...
            <div 
            className='group fixed right-10 md:right-18 bottom-24 md:bottom-6 bg-transparent p-2 rounded-full z-40'
