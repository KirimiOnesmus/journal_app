...
const Navbar = () => {
  ...
  return (
    <div>
        ...
        {/* Desktop screen */}
        <aside className="hidden md:flex flex-col w-52 h-screen bg-white shadow-md py-4 gap-1">
            <h3><a href="#" className='flex gap-2 text-2xl mb-6 font-bold'>Daily Journal<MdMenuBook className='text-blue-400'/></a></h3>
            {sidebar.map((item) => (
                <Link  
                key={item.name}
                to={item.route}
            ...
            <div className="flex items-center gap-2 p-3 mt-auto hover:bg-gray-100 cursor-pointer rounded-full">
          ...
          <nav className='md:hidden fixed bottom-4 left-0 right-0 bg-transparent  shadow-lg flex justify-around py-2 z-50 backdrop-blur-lg rounded-full mx-4 mb-2'>
            ...
            <div className='cursor-pointer flex items-center justify-center p-1 rounded-full hover:bg-gray-100'>
